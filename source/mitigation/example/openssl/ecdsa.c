...
// gcc -o ecdsa ecdsa.c ../../PDM-encrypt.c -g -O0 -no-pie -fno-omit-frame-pointer -fno-stack-protector -maes -msse2 -march=native -lcrypto -lcapstone -pthread -DPDM_MASKING=1
